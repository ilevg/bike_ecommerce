    ...
    return (
        <>
            ...
            <form className={styles.form}>
                <label className={styles.lable} htmlFor="email">E-mail</label>
                <input className={styles.input} type="email" placeholder="example@email.com" name="email" value={loginDetails.email} onChange={handleChange}/>

                <label className={styles.lable} htmlFor="password">Password</label>
                <input className={styles.input} type="password" name="pass" value={loginDetails.pass} onChange={handleChange}/>

                <div className={styles.btnLogin} >
                    <Button type='submit' width='100%' text='Log in' value="Go" onClick={handleSubmit} />
                </div>
